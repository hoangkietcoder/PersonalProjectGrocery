...
class GioHangPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ModelProductLocalBloc(DataLocalRepository: context.read<DataLocalRepository>())..add(RefreshListProDuctLocalCartEvent()),
                          ...
                          showDialog(
                            ...
                            if (value != null && value) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(content: Text('Đã xóa tất cả sản phẩm thành công')),
                              );
                            }
                          });
                              },
