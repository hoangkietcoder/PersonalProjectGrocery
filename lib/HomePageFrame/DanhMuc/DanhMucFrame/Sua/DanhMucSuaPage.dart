...
class DanhMucSuaPage extends StatelessWidget {

  final SuaRepository suaRepository;

  const DanhMucSuaPage({super.key, required this.suaRepository});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const DanhMucSuaView(),
    );
  }
}


class DanhMucSuaView extends StatefulWidget {
  const DanhMucSuaView({super.key});

  @override
  State<DanhMucSuaView> createState() => _DanhMucSuaViewState();
}
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'Tìm kiếm theo sản phẩm theo sữa ...',
                hintStyle: TextStyle(
                  fontSize: 13.sp,
                ),
