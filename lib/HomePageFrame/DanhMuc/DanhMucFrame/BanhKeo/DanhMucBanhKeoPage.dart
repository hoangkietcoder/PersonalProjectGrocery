...
class DanhMucBanhKeoPage extends StatelessWidget {

  final SuaRepository suaRepository;

  const DanhMucBanhKeoPage({super.key, required this.suaRepository});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const DanhMucBanhKeoView(),
    );
  }
}


class DanhMucBanhKeoView extends StatefulWidget {
  const DanhMucBanhKeoView({super.key});

  @override
  State<DanhMucBanhKeoView> createState() => _DanhMucBanhKeoViewState();
}

class _DanhMucBanhKeoViewState extends State<DanhMucBanhKeoView> {
        ...
        children: [
          Padding(
            ...
            child: TextField(
              ...
              onChanged: (value) => context.read<SuaBloc>().add(SearchProductDanhMuc(value.trim(),3,userId)), // lưu thay đổi vào state, để tìm kiếm sản phẩm
              decoration: InputDecoration(
                ...
                hintText: 'Tìm kiếm theo sản phẩm theo bánh kẹo ...',
                hintStyle: TextStyle(
                  fontSize: 13.sp,
                ),
              ...
              builder: (context, state) {
                ...
                if (isSearching) {
                  ...
                  if (state.statusSearch == StatusSearch.loading) {
                    ...
                    return const Center(child: Text('Không tìm thấy sản phẩm bánh kẹo.'));
                  }
                } else {
                  // LOAD BAN ĐẦU
