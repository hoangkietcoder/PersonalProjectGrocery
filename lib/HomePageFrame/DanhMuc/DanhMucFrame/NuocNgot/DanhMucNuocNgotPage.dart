...
class DanhMucNuocNgotPage extends StatelessWidget {

  final SuaRepository suaRepository;

  const DanhMucNuocNgotPage({super.key, required this.suaRepository});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const DanhMucNuocNgotView(),
    );
  }
}


class DanhMucNuocNgotView extends StatefulWidget {
  const DanhMucNuocNgotView({super.key});

  @override
  State<DanhMucNuocNgotView> createState() => _DanhMucNuocNgotViewState();
}

class _DanhMucNuocNgotViewState extends State<DanhMucNuocNgotView> {
        ...
        children: [
          Padding(
            ...
            child: TextField(
              ...
              onChanged: (value) => context.read<SuaBloc>().add(SearchProductDanhMuc(value.trim(),6,userId)), // lưu thay đổi vào state, để tìm kiếm sản phẩm
              decoration: InputDecoration(
                ...
                hintText: 'Tìm kiếm tên sản phẩm theo nước ngọt...',
                hintStyle: TextStyle(
                  fontSize: 13.sp,
                ),
              ...
              builder: (context, state) {
                ...
                if (isSearching) {
                  ...
                  if (state.statusSearch == StatusSearch.loading) {
                    ...
                    return const Center(child: Text('Không tìm thấy sản phẩm nước ngọt nào.'));
                  }
                } else {
                  // LOAD BAN ĐẦU
                  if (state.statusLoadSua == StatusLoadSua.loading) {
                    ...
                    return const Center(child: Text('Không có sản phẩm nước ngọt.'));
                  }
                }
