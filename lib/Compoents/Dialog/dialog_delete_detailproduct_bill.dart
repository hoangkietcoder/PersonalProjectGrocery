...
class DialogDeleteDetailProductlBill extends StatelessWidget {
  const DialogDeleteDetailProductlBill({super.key});
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Text(
        "Bạn có muốn xóa sản phẩm này không?", style: TextStyle(color: Colors.black,fontSize: 12.sp),),
      actions: [
        TextButton(
          onPressed: () {
