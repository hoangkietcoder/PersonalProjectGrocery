...
class DialogDeleteAllProduct extends StatelessWidget {
  const DialogDeleteAllProduct({super.key});
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Text(
        "Bạn có muốn xóa tất cả sản phẩm này không?", style: TextStyle(color: Colors.black,fontSize: 12.sp),),
      actions: [
        TextButton(
          onPressed: () {
